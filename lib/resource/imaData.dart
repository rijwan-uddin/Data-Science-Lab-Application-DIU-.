...
class imadata extends StatefulWidget {
  @override
  _ExpandedTextWidgetState createState() => _ExpandedTextWidgetState();
}

class _ExpandedTextWidgetState extends State<imadata> {
      ...
      child: Column(
        ...
        children: [
          ...
          isExpanded
            ...
            maxHeight: 60,
            child: Text(
              "Categorical data in machine learning represents non-numeric attributes with a fixed number of possible values. Handling techniques include...",
              textAlign: TextAlign.justify,
              style: TextStyle(fontSize: 18, color: Colors.white),
            ),
          ),
